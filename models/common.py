...
class AutoShape(nn.Module):
    ...
    def forward(self, ims, size=640, augment=False, profile=False):
        ...
        #   OpenCV:          = cv2.imread('imge.jpg')[:,:,::-1]  # HWC BGR to RGB x(640,1280,3)
        #   PIL:             = Image.open('imge.jpg') or ImageGrab.grab()  # HWC x(640,1280,3)
...
class Detections:
    ...
    def get_objects(self):
        ...
        for pred in pred_tensor:
            ...
            # 添加到列表中
            object_info.append((class_idx, confidence))
